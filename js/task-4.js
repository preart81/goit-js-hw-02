...
function getShippingCost(country) {
  // Перевіряє можливість доставки товару в країну користувача (параметр country)
  // і повертати повідомлення про результат. Обов'язково використовуй інструкцію
  // switch.
  ...
  return price
    ? `Shipping to ${country} will cost ${price}`
